...
const aiToolsRaw = [
    ...
    { id: 'doc-notebooklm', name: 'NotebookLM (Google)', tagline: 'ผู้ช่วยวิจัยและสรุปเอกสารอัจฉริยะ', description: 'ใช้ AI วิเคราะห์เอกสารที่คุณอัปโหลดเพื่อสร้างข้อสรุป ตอบคำถาม และสร้างไอเดียใหม่ๆ โดยอ้างอิงจากแหล่งข้อมูลที่คุณกำหนดไว้เท่านั้น', category: 'document', provider: 'Google', imageUrl: '/images/notebooklm.png', officialWebsite: 'https://notebooklm.google.com/' },
    { id: 'creative-imagen3', name: 'Imagen 3 (Google)', tagline: 'โมเดลสร้างภาพคุณภาพสูงจาก Google', description: 'เทคโนโลยีสร้างภาพจากข้อความระดับเรือธงที่ให้ความสมจริงสูง และเข้าใจรายละเอียดของพรอมต์ที่ซับซ้อนได้อย่างดีเยี่ยม', category: 'creative', provider: 'Google', imageUrl: '/images/imagen3.png', officialWebsite: 'https://deepmind.google/technologies/imagen-3/' },
    { id: 'coding-idx', name: 'Project IDX (Google)', tagline: 'เครื่องมือเขียนโค้ดบน Cloud พร้อมพลัง AI', description: 'สภาพแวดล้อมการพัฒนาแอปพลิเคชัน (IDE) บนเว็บที่ผสานพลังของ Gemini เพื่อช่วยให้การเขียนโค้ดสะดวกและรวดเร็วขึ้น', category: 'coding', provider: 'Google', imageUrl: '/images/project-idx.png', officialWebsite: 'https://idx.dev/' },
    { id: 'doc-deepseek', name: 'DeepSeek', tagline: 'โมเดลภาษาขั้นสูงเพื่อการวางแผนและจัดการเอกสาร', description: 'AI ที่มีความสามารถสูงในการคิดวิเคราะห์เชิงตรรกะ ช่วยร่างเอกสารและวางแผนโปรเจกต์ได้อย่างแม่นยำและรวดเร็ว', category: 'document', provider: 'DeepSeek', imageUrl: '/images/deepseek.png', officialWebsite: 'https://www.deepseek.com/' },
    { id: 'doc-perplexity', name: 'Perplexity AI', tagline: 'AI ค้นคว้าข้อมูลพร้อมแหล่งอ้างอิงที่เชื่อถือได้', description: 'ผู้ช่วยค้นคว้าวิจัยที่ทำงานเหมือน Search Engine ผสมแชทบอท โดยจะให้คำตอบพร้อมระบุแหล่งที่มาของข้อมูลอย่างชัดเจน', category: 'document', provider: 'Other', imageUrl: '/images/perplexity.png', officialWebsite: 'https://www.perplexity.ai/' },
    { id: 'coding-aistudio', name: 'Google AI Studio', tagline: 'เครื่องมือพัฒนาและทดสอบโมเดล AI สำหรับสายโค้ด', description: 'แพลตฟอร์มสำหรับนักพัฒนาในการสร้างและทดสอบ Prompt (Prompt Engineering) รวมถึงการทดลองใช้งานโมเดล Gemini ล่าสุด', category: 'coding', provider: 'Google', imageUrl: '/images/google-ai-studio.png', officialWebsite: 'https://aistudio.google.com/' },
    { id: 'plan-opal', name: 'Opal', tagline: 'ผู้ช่วยวางแผนและจัดการชีวิตดิจิทัลอย่างปลอดภัย', description: 'AI ที่เน้นการวางแผนและเพิ่มสมาธิในการทำงาน โดยช่วยจำกัดการเข้าถึงแอปที่ไม่จำเป็นและเน้นความปลอดภัยของข้อมูล', category: 'planning', provider: 'Other', imageUrl: '/images/opal.png', officialWebsite: 'https://www.opal.so/' },
    { id: 'coding-github-copilot', name: 'GitHub Copilot', tagline: 'คู่หู AI สำหรับการเขียนโค้ดที่นักพัฒนาทั่วโลกไว้วางใจ', description: 'AI Programmer ที่ช่วยแนะนำโค้ดแบบเรียลไทม์ภายในหน้า IDE ของคุณ ช่วยให้เขียนฟังก์ชัน เขียนเทสต์ และแก้บัคได้เร็วขึ้นหลายเท่า', category: 'coding', provider: 'Microsoft', imageUrl: '/images/github-copilot.png', officialWebsite: 'https://github.com/features/copilot' },
    { id: 'creative-ms-designer', name: 'Microsoft Designer', tagline: 'ออกแบบกราฟิกสุดโปรด้วยพลัง AI', description: 'เครื่องมือออกแบบที่รวมพลังของ DALL-E 3 เพื่อสร้างรูปภาพและงานดีไซน์ตามคำสั่งของคุณ ช่วยเพิ่มความสวยงามให้คอนเทนต์โซเชียลมีเดีย', category: 'creative', provider: 'Microsoft', imageUrl: '/images/ms-designer.png', officialWebsite: 'https://designer.microsoft.com/' },
    { id: 'coding-azure-studio', name: 'Azure AI Studio', tagline: 'แพลตฟอร์มพัฒนา AI ระดับองค์กรจาก Microsoft', description: 'ศูนย์รวมการสร้าง พัฒนา และทดสอบโซลูชัน Generative AI ที่มีความปลอดภัยและมาตรฐานระดับสูง เหมาะสำหรับการสร้างแอปพลิเคชัน AI ขนาดใหญ่', category: 'coding', provider: 'Microsoft', imageUrl: '/images/azure-ai-studio.png', officialWebsite: 'https://ai.azure.com/' },
