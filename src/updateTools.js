...
const updates = {
    ...
    'plan-timeline-asana': `plans: [\n      { name: 'Intelligence', price: '~$25+', forOrg: true, features: 'รวมในแพ็กเกจ Business' }\n    ],\n    orgSuitability: 'องค์กรสามารถใช้งานได้ทุกคน'`
};
